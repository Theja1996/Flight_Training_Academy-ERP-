...
import "../CreateCrewPage/CreateCrew.css";
...
function CreateCrew() {
  ...
  useEffect(() => {
    ...
    return function cleanup() {
      remove_key("FlightCrew", keyValue);
    };
  }, []);
  ...
  const DocreateStudent = () => {
    ...
    // try {
    //   const res = Axios.post("http://localhost:5000/api/CrewCreated", datas);
    //   if (res.status === 201) {
