...
export default function StudentsG(props) {
  ...
  const gridStyle = {
    ...
    "url( http://localhost:3000/static/media/Picture2.d1454b39.png)" ,
      color: "white",
        ...
        <Row justify="space-between ">
          ...
          >
            <Row justify="space-between " style={{ marginTop: "15px" }}>
              <h3 style={{ fontWeight: "bold" }}>{pl}</h3>
          ...
          <Space size="large" direction="vertical">
            <Card bordered={false}>
              {props.programList[pl].map((item) => (
                <Card.Grid style={gridStyle}>
                  <Card style={metaStyle}>
                    <Space size="-7px" direction="vertical">
