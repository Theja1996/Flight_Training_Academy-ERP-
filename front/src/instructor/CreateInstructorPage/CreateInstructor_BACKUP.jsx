...
import "../csscomonents/EditUser.css";
...
import "../CreateInstructorPage/CreateInstractor.css";
import Axios from "axios";
import { add, getMaxId, remove_key } from "../utils/APIUtils";

function CreateInstractor() {
  ...
  useEffect(() => {
    getMaxId("FlightInstractor")
      .then((result) => setkeyValue(result))
      .catch((error) => console.log(error));

    return function cleanup() {
      remove_key("FlightInstractor", keyValue);
    };
  }, []);
  ...
  const DocreateStudent = () => {
    ...
    //     "http://localhost:5000/api/instractorCreated",
    //     datas
    //   );
    //   if (res.status === 201) {
    ...
    //     }
    //   );
    window.location = "/CreateInstractor";
  };
                            ...
                            <Form.Item shouldUpdate={true}>
                              {() => (
                                <Button
                                  ...
                                  // }
                                >
                                  <CheckOutlined /> Create Instractor
                                </Button>
                              )}
                            </Form.Item>
                          </Col>
...
export default CreateInstractor;
