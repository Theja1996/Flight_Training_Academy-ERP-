...
import "../CreateStaffPage/CreateStaff.css";
...
function CreateStaff() {
  ...
  useEffect(() => {
    ...
    return function cleanup() {
      remove_key("FlightStaff", keyValue);
    };
  }, []);
  ...
  const DocreateStudent = () => {
    ...
    // try {
    //   const res = Axios.post("http://localhost:5000/api/CreateStaff", datas);
    //   if (res.status === 201) {
