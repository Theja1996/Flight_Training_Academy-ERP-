...
export default function AdministratorList(props) {
  let history = useHistory();
  const [selectionType, setSelectionType] = useState("checkbox");
  const [selectedrows, setSelectedrows] = useState([]);
  const [getAdministratordata, setgetAdministratordata] = useState([]);
  function handleEdit(data) {
    history.push({
      pathname: "/EditAdministrator",
      state: { detail: data },
    });
  }
        ...
        <Row justify="center">
          <Table
           ...
           // ...rowSelection,
            ...
            //   srList = srList.filter((sr) => sr.instructordata !== pl);
            ...
            title={() => (
              ...
              >
                ...
                >
                  <h3 style={{ fontWeight: "bold" }}> Administrator</h3>
                 
                </Row>
              </Header>
            )}
            dataSource={props.Administratordata}
            columns={columns}
          />
          <BackTop
