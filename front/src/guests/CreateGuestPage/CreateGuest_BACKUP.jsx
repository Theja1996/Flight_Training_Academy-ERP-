...
import "../CreateGuestPage/CreateGuest.css";
...
function CreateGuest() {
  ...
  useEffect(() => {
    ...
    return function cleanup() {
      remove_key("FlightGuest", keyValue);
    };

    const studentdetailes = async () => {
      try {
  ...
  // let studentName = [];
  let stuData = [];
  const stuName = studentdata.map((item) => {
    if (item._fieldsProto.class.integerValue === "3700") {
      stuData.push(item);
    }
  });

  let stuData1 = [];
  const stuName1 = studentdata.map((item) => {
    if (item._fieldsProto.class.integerValue === "3554") {
      stuData.push(item);
    }
  });
  let stuData2 = [];
  const stuName2 = studentdata.map((item) => {
    if (item._fieldsProto.class.integerValue === "3697") {
      stuData2.push(item);
    }
  });
  let stuData3 = [];
  const stuName3 = studentdata.map((item) => {
    if (item._fieldsProto.class.integerValue === "3728") {
      stuData3.push(item);
    }
  });
  let stuData4 = [];
  const stuName4 = studentdata.map((item) => {
    if (item._fieldsProto.class.integerValue === "4193") {
      stuData4.push(item);
    }
  });
  let stuData5 = [];
  const stuName5 = studentdata.map((item) => {
    if (item._fieldsProto.class.integerValue === "4194") {
      stuData5.push(item);
    }
  });
  let stuData6 = [];
  const stuName6 = studentdata.map((item) => {
    if (item._fieldsProto.class.integerValue === "4040") {
      stuData6.push(item);
    }
  });
  let stuData7 = [];
  const stuName7 = studentdata.map((item) => {
    if (item._fieldsProto.class.integerValue === "4484") {
      stuData7.push(item);
    }
  });
  ...
  const DocreateStudent = () => {
    ...
    // try {
    //   const res = Axios.post("http://localhost:5000/api/guestCreated", datas);
    //   if (res.status === 201) {
                              ...
                              <Row>
                                <Col span={11}>
                                  ...
                                  >
                                    <p></p>
                                    <p>
                                      Below you can give this guest access to
                                      one or multiple users. The access will be
                                      in a view-only mode.
                                    </p>
                                    <Select
                                      defaultValue="none"
                                    ...
                                    >
                                      ...
                                      <option value={3700}>
                                        2020 Feb-BAK Batch 01
                                      </option>
                                      <option value={3728}>
                                        2020 Feb-PPL Batch 01
                                      </option>
                                      <option value={4193}>
                                  ...
                                  >
                                    {classtype === 3700
                                      ? stuData.map((item) => (
                                          <p>
                                            {
                                              item._fieldsProto.firstname
                                                .stringValue
                                            }
                                            -
                                            {
                                              item._fieldsProto.lastname
                                                .stringValue
                                            }
                                          </p>
                                        ))
                                ...
                                <Col span={11}>
                                  ...
                                  >
                                    <Checkbox
                                      ...
                                      checked={checkone}
                                    >
                                      Access to user programs (including
                                      progress and report generator)
                                    </Checkbox>
                                    <br />
                                    <Checkbox
                                      onChange={check2}
                                    ...
                                    <Checkbox
                                      ...
                                      checked={checkthree}
                                    >
                                      Access to user certificates (including
