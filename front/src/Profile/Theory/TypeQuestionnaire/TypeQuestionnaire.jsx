...
export default function TypeQuestionnaire(props) {
  const { Option } = Select;
  ...
  function handleTypeQuestionnaire(data) {
    history.push("/users/" + key + "/team_type_questionnaires/new");
  }
  useEffect(() => {
    ...
    <>
      ...
      <div style={{ margin: 20 }}>
        ...
        <Row>
          <Button
            //  onClick={showModal}
            onClick={() => handleTypeQuestionnaire()}
            style={{
              marginTop: "20px",
            }}
          >
