...
export default function Atpl(props) {
  ...
  const columns = [
    {
      ...
      render: (rData, record) => (
        ...
        <Button onClick={()=>handleProfile(record) } style={{ color: "#1394e4" }} type="link" > {record.user_First_name + "-" + record.user_Last_name}</Button>
...

    {
      title: "",
      render: (text,record) => (
        <Button onClick={()=>handleEdit(record) }   type="text" icon={<FaPencilAlt style={{ color: "#1394e4" }} />}/>
            ...
            <Table
              ...
              title={() => (
                ...
                >
                  ...
                  >
                    <h3 style={{ fontWeight: "bold" }} >  {(a, b) => a.pl.localeCompare(b.pl)}{pl}</h3>
