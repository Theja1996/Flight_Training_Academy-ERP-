...
export default function Syllabus_me_ir_dgca() {
  ...
  const columns = [
          ...
          children: [
            {
              title: (
                <Text>
                15:00 <br></br> <Text type="secondary">00.00</Text>
                </Text>
              ),
              dataIndex: "dual_val",
            },
          ...
          children: [
            {
              title: (
                <Text>
                  10:00 <br></br> <Text type="secondary">0.00</Text>
                </Text>
              ),
              dataIndex: "sim_val",
            },
    ...
    {
      title: "",
      children: [{title:"ME",  dataIndex: "me",children:[{title:(
        <Text>
          ...
          children: [
            {
              title: (
                <Text>
                 2:30 <br></br> <Text type="secondary">0.00</Text>
                </Text>
              ),
              dataIndex: "nt_val",
            },
          ...
          children: [
            {
              title: (
                <Text>
                6:18 <br></br> <Text type="secondary">0.00</Text>
                </Text>
              ),
              dataIndex: "if_val",
            },
          ...
          children: [
            {
              title: (
                <Text>
                  15:00 <br></br> <Text type="secondary">(0.00)</Text>
                </Text>
              ),
              dataIndex: "dual_val",
            },
